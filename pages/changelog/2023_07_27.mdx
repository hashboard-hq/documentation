...
**[Transpose Tables](https://docs.hashboard.com/changelog/2023_04_20#transpose-tables)** - The control panel is full of data viz goodies, including the toggle for transpose tables. Switch the positions of your rows and metrics by switching this on.
