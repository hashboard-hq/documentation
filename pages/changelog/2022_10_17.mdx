---
description: Changelog for October 17th, 2022
---

# October 17th, 2022

Hi Hashboard friends,

As autumn rolls in, we’ve been focusing on making it easy to share the insights you’ve found in Hashboard. At the same time, we’ve made some serious usability improvements to our data explorer and model builder.
...
Exploring data is core to Hashboard and now it’s even easier to share what you’ve found. You can now get a link to your current exploration with a single click.
...
It’s now easier to explore numeric data in Hashboard. New controls for the attribute tray and chart axes allow you to change bin widths and bin settings right from the explorer, so you can quickly zoom in and out of numeric data.
...
- **MySQL support:** Hashboard added support for MySQL and other MySQL-compatible databases like MariaDB.
...
- **Foldable schemas in Model Workbench:** you probably have a lot of tables in your database and navigating through them in Hashboard was a bit tricky. We now support collapsing your tables under their respective schemas to keep things more organized. You can still search through all of your tables.
