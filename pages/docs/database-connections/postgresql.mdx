---
description: Postgres is a great default choice for a database engine
---
...
- [Set up your data warehouse on Postgres in 30 minutes](https://hashboard.com/blog-posts/setup-your-data-warehouse-on-postgres-in-30-minutes)
...
- **Schema:** (_optional_) Specify a schema to limit which tables are available. Otherwise, Hashboard will make all accessible schemas and tables available.
