...
<Callout type="info">
  **Local cache**— Hashboard keeps a copy of cached data in your web browser while
...
You can bypass the query cache by using the `Refresh Data` button, found in the dropdown menu in the upper-right corner when viewing a saved exploration. Additionally, there is a clickable "refresh" icon found next to `Data fetched at <time>` at the top of the explorer.
