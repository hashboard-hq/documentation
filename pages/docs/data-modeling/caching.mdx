---
description: By default, query results are cached in Hashboard for four hours, but this is configurable for each data model with the Time To Live (TTL) configuration.
---
