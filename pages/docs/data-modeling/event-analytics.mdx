...
By adding a bit of additional configuration to define these concepts in an existing data model, you can begin interactively analyzing funnels in Hashboard. These new abilities inherit all the functionality of the current models. You can save these explorations and add them to your dashboards, just like you would with our current chart types.
