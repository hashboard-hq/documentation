...
To organize your attributes into folders in a data model:
...
4. From the dropdown, select the folder to which you want to move the attribute.
...
6. Repeat steps 2-5 for each attribute you want to organize into a folder.
