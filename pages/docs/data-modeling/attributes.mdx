...
SQL can reference other attributes by surrounding their `alias` in curly braces. When querying, Hashboard will expand references to their full definitions.
