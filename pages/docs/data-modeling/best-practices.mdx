...
=======
  **Row count metric is required**— You can't remove the row count metric from a
  data model in Hashboard (at least, not very easily). It's good practice to rename
...
>>>>>>> fd6fbf1 (Initial pass at renaming Glean to Hashboard)
</Callout>
...
<Callout>
  **Next Steps**- If you're ready to begin building in Hashboard, learn how to [add
