---
description: Project search in Hashboard allows you to quickly locate and navigate to various resources within your project such as models, saved explorations, measures, metrics, and dashboards.
---
...
<Callout type="info">
  ...
  go to? [Data Search](/docs/visualizing-data/data-search) provides a way for
  you to start exploring any attribute or measure in your project without having
  to navigate to specific resource.
</Callout>
