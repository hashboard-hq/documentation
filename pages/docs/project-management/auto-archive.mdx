...
- **Exclude resources based on [status](/docs/project-management/resource-metadata#status)**: Select resources by their status (e.g., Exploratory, In Progress, Verified, Archive, No status) to exclude from being auto-archived.
