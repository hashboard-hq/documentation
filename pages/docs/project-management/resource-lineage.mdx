...
Follow this link: [Resource Lineage](https://hashboard.com/app/p/data-ops#resource_lineage) or
...
1. Goto to the [models page](https://hashboard.com/app/m/data-models)
2. Edit a model
