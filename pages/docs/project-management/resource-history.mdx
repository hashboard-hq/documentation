...
- For a specific **data models**, **saved explorations**, or **dashboards** you can view the history of that resource by navigating to the appropriate page from the 
...
When changes are shown in comparison to the previous version of the resource, sometimes there are changes that are shown in the comparison.
