---
description: Sandbox demo projects are an easy way to use all functionality in Hashboard with pre-loaded public datasets.
---

# Sandbox Demo Projects

Sandbox demo projects are an easy way to use all functionality in Hashboard with pre-loaded public datasets.
...
- Experimentation with new features in Hashboard without modifying your own resources.
- Getting started with Hashboard before you're able to connect your own data warehouse.
...
2. Go to the [`Settings`](https://hashboard.com/app/p/settings#project_administration) page using the link in the project dropdown.
