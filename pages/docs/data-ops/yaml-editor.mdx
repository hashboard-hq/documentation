...
[Data Model Config Schema](/docs/data-ops/config-schema/data-models) for how to format
...
[Saved Exploration Config Schema](/docs/data-ops/config-schema/saved-explorations) for how to format
your config files in the YAML editor.

## Enabling the YAML Editor in the Dashboard editor

Open the dashboard code editor by clicking the "Code" button in the dashboard's toolbar. This will open the code editor alongside your dashboard.
