---
description: The preview command is a safe way to see what Hashboard configuration files will look like inside of Hashboard without affecting the state of the BI tool
---
