...
If you've just updated a specific resource and want to ensure that all users view the most recent data regardless of the default cache ttl you can clear the cache from the CLI.
