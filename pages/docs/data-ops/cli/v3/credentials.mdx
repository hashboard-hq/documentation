---
description: How to supply credentials to the Hashboard CLI
---

# Credentials

The CLI is authenticated by an access key. To create a new access key, run the [`token`](/docs/data-ops/cli/v3/token) command or go to
...
hb --credentials-filepath your/absolute/filepath build
```
