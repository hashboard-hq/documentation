...
The Hashboard CLI lets you build your Hashboard resources from configuration files, with [preview](./cli/preview) builds and [deployments](./cli/deploy).
...
Use the [deploy command](./cli/deploy) to write your changes back to your Hashboard project. By default you'll be able to preview your changes before they're published.
