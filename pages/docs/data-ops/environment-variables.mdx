...
Environment variable substitution happens at build-time, when you create a Preview or Deploy build.
...
2. [Default environment variables](#setting-default-environment-variables) set on the project you are deploying to
