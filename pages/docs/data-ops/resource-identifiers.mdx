...
## Hashboard Resource Names (GRNs)

A Hashboard Resource Name or GRN is a way to reference Hashboard resources in a stable way.
...
the Hashboard web app into DataOps, without recreating it.
