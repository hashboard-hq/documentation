...
After you've configured a Git repository, you can navigate to the [`DataOps`](https://hashboard.com/app/p/data-ops) page and click `+ New Build` to create a new Build, with the following options:
