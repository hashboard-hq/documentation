---
description: Hashboard can directly create builds using configuration files stored in an external Git repository.
---

# Git Integration

Hashboard can directly create builds using configuration files stored in an external Git repository.
