...
Currently, the public GraphQL API supports fetching metadata on Projects, Models, Saved Explorations, Metrics, and Dashboards. [Contact us](mailto:support@hashboard.com) if you are interested in accessing additional Hashboard resources via the public GraphQL API.
