...
<Cards num={2}>
  <Card arrow title="Quickstart in the App" href="/docs/getting-started/quick-start"/>
  <Card arrow title="Quickstart from the Command Line" href="/docs/data-ops/quickstart" />
</Cards>
