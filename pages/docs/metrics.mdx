...
<Callout type="warning">
  **Are you looking for measures?** Hashboard previously used the term **metric** to refer to what is now called a **measure**. Read more about [measures](/docs/data-modeling/measures).
</Callout>
...
To create a timeseries metric, make sure your metric's configuration has the **Dimension** set to an attribute, rather than **None**.
...
4. The metric editor will appear. From here you can edit the various aspects of the metric.
    ...
    - **Display current (incomplete)** - Whether or not to include the current time period in the metric. 
...
5. Once you have finished editing the metric, click the **Save** button at the bottom of the metric editor.
6. Your metric will be updated with the new configuration.
...
Clicking the metric from the metrics page will take you to the **Date Explorer** where you can explore the metric in more detail. 
