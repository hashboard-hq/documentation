...
7. Your metric tile will now display the selected metric, to make changes to the value displayed you can edit the metric definition from the [Metrics page](#metric-page).
...
8. Your metric tile's configuration will be updated with the configuration from your metric. You can open the metric tile's configuration to review the settings or make additional changes.
