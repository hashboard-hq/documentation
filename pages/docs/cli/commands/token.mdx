...
The token command lets you authenticate the CLI.  You can also go to your [settings page]([`Settings`](https://glean.io/app/p/settings#access_keys) in the web UI to create and manager your access tokens.
