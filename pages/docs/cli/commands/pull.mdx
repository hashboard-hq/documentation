...
You can also pull resources that were not built with the `hb pull -all` command.  If you want to pull down a resource that was built in the UI, you have two options:
