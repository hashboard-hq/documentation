...
**Metric Value:** Choose a [data model](/docs/data-modeling/data-models-overview) and measure to display. Then select the date or number that you want to aggregate the metric over and adjust the granularity or bin size to see values over the most recent week, month, etc of your dataset.
