...
You can embed external content in your dashboards using an embed block. Under the hood, this just adds an `<iframe>` of the external content into the dashboard block.
