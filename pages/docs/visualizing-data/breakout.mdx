---
description: Breaking out an attribute in Hashboard splits the visualization by the categories in that attribute
---
...
Breaking out an attribute in Hashboard splits the visualization by the categories in that attribute. In a timeseries bar chart for example, you can map color to an attribute.
