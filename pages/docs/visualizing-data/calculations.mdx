---
description: Hashboard supports adding calculations such as rolling averages to your Measures
---
...
Hashboard supports adding calculations such as rolling averages to your [Measures](/docs/data-modeling/measures).
You can add calculations when you are exploring any data model or saved exploration directly from the [Measures](/docs/data-modeling/measures) dropdown.
