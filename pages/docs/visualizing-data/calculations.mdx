...
<Callout type="info">
  `Null` values in the calculation will be treated as `0`. In window functions such as 
  Rolling sum and Rolling average, they will not be included in the size of the window.
</Callout>
