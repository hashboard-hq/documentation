---
description: Saved Explorations and Data Models are often starting points for further exploration and analysis. Hashboard makes it safe and easy to take resources further and share what you've found with the `Explorations` feature.
---
