...
Click the `Stop exploring` button to reset back to the data model's default configuration at any time. Glean will save your place for each resource for you to return to later.
