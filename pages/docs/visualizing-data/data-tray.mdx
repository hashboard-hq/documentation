---
description: The data tray allows you to view your available data, and configure explorations
---

# Data Tray

The data tray allows you to view your available data, and configure
...
## Organizing the data tray with folders

Measures and attributes can be organized into folders to make it easier to navigate the data tray.
[Measure folders](/docs/data-modeling/measures#measure-folders) and [attribute folders](/docs/data-modeling/attributes#attribute-folders) can be configured in the model builder.
