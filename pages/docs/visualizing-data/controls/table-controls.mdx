...
- **Subtotals**: Adds subtotals and a grand total to your table. Subtotals are calculated per table group (i.e. for each table attribute, including the breakout if it exists), and are calculated before the row limit is applied.
