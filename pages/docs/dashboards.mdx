...
You can organize dashboard sections into tabs to create multiple views within a single dashboard.
To add tabs, go to edit mode and click the "+ Tab" button in the top bar. Give each tab a meaningful name,
and then move sections between tabs using the "Move to tab" dropdown in the top right of each section. This
is particularly useful for grouping related visualizations together or creating different views for
different audiences while keeping everything in one dashboard.
