...
|------------------------------|-------------------------------------------------------------------------------------------------------------------|------------------------|
| **[Role-based Access Controls](/docs/project-management/users-and-permissions#system-provided-roles)** | Define roles in Hashboard and assign specific governance and access rules to these roles, enforced by Hashboard.     | Data Access, Governance |
...
| **[Private Resources](/docs/dashboards)**          | Dashboards and Saved Explorations can be marked private, which hides it from all other users in your project. | Governance |
