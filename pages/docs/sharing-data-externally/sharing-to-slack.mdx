...
Slack reports can be sent as either images or PDF files, configured with the "File type" dropdown when sharing a resource to Slack.

Images are included inline in the Slack message, whereas PDF files are uploaded as a separate file into your Slack channel.
