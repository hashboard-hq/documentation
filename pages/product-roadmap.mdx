...
- <del>Pull command in the CLI</del> [launched June](/changelog/2023_06_30#improved-dataops-workflow-with-glean-pull)
...
-  <del>Data library with metrics</del> [launched September](/docs/metrics) and attribute pages 
