...
- <del>Pull command in DataOps</del> [launched June](/changelog/2023_06_30#improved-dataops-workflow-with-glean-pull)
...
- <del>Much better data search</del> [launched September](/docs/visualizing_data/quick-explore)
